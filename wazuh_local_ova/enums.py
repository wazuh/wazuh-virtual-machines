...
class ArtifactFilePath(StrEnum):
    ...
    def build(self, version: str = "", revision: str = "") -> str:
        ...
        Examples:
            ...
            'https://packages.wazuh.com/production/1.x/artifact-urls/artifact_urls_1.2.3.yaml'

            >>> ArtifactFilePath.PRE_RELEASE.build(version="1.2.3", revision="1")
            'https://packages-staging.xdrsiem.wazuh.info/pre-release/1.x/artifact-urls/artifact_urls_1.2.3-1.yaml'
