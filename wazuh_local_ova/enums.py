...
class ArtifactFilePath(StrEnum):
    ...
    def build(self, version: str = "", revision: str = "") -> str:
        ...
        Args:
            version: Full Wazuh version string (e.g. ``"5.0.1"``).
        ...
        Examples:
            >>> ArtifactFilePath.RELEASE.build(version="5.0.1")
            'https://packages.wazuh.com/production/5.x/artifact-urls/artifact_urls_5.0.1.yaml'

            >>> ArtifactFilePath.PRE_RELEASE.build(version="5.0.1", revision="1")
            'https://packages-staging.xdrsiem.wazuh.info/pre-release/5.x/artifact-urls/artifact_urls_5.0.1-1.yaml'
