...
class ArtifactFilePath(StrEnum):
    ...
    def build(self, version: str = "", revision: str = "") -> str:
        ...
        Args:
            version: Full Wazuh version string (e.g. ``"5.1.0"``).
        ...
        Examples:
            >>> ArtifactFilePath.RELEASE.build(version="5.1.0")
            'https://packages.wazuh.com/production/5.x/artifact-urls/artifact_urls_5.1.0.yaml'

            >>> ArtifactFilePath.PRE_RELEASE.build(version="5.1.0", revision="1")
            'https://packages-staging.xdrsiem.wazuh.info/pre-release/5.x/artifact-urls/artifact_urls_5.1.0-1.yaml'
