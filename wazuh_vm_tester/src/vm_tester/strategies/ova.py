...
class OVAStrategy(ConnectionStrategy):
    ...
    def install_dependencies(self) -> bool:
        ...
        try:
            ...
            command = """cd /tmp/wazuh-virtual-machines && PYTHONPATH=/tmp/wazuh-virtual-machines
                        hatch run dev-ova-pre-configurer-install-dependencies:run """
    ...
    def import_ova(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error importing OVA: {traceback.print_exc()}")
            return False
    ...
    def port_forward(self) -> bool:
        ...
        try:
            ...
            logger.error(f"Error setting up port forwarding: {traceback.print_exc()}")
            return False
