...
from .formatters import ConsoleFormatter, GithubActionsFormatter, JSONFormatter, MarkdownFormatter
...
class ReportManager:
    ...
    def add_pytest_result(self, nodeid: str, status: str, message: str = "", duration: float = 0.0) -> None:
    ...
    def save_report(self, filename: str, format_type: str | None = None) -> None:
        ...
        if format_type == "text" or format_type == "console" and os.path.exists(filename):
