...
class AnsibleConnection(ConnectionInterface):
    ...
    def __init__(self, inventory_path: str, host_id: str | None = None, connection_id: str | None = None):
    ...
    def connect(self, **kwargs) -> "AnsibleConnection":
        ...
        self._connection_info = get_host_connection_info(self._inventory_path, self._host_id)
