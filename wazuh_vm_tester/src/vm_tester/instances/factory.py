...
def create_instance(config: AMITesterConfig) -> InstanceInterface | None:
    ...
    if config.ssh_host:
        ...
        return EC2Instance(instance_id="direct-ssh", region=config.aws_region, public_ip=config.ssh_host)
