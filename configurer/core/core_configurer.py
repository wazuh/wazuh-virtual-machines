...
class CoreConfigurer:
    ...
    def configure(self, client: paramiko.SSHClient | None = None):
        ...
        config_mappings.replace_file_entries(CertificatesComponent.INDEXER, client=client)
        config_mappings.replace_file_entries(CertificatesComponent.MANAGER, client=client)
        config_mappings.replace_file_entries(CertificatesComponent.DASHBOARD, client=client)
