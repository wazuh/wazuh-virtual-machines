...
| Issue | Comment |
| - | - |
| [#6086](https://github.com/wazuh/internal-devel-requests/issues/6086) | Leave the Wazuh services disabled in the AMI so they do not race the customizer on first boot |
