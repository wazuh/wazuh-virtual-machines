...
@patch("builtins.open", new_callable=mock_open, read_data=yaml.dump(INVENTORY_WITHOUT_HOSTS_KEY))
...
@patch("builtins.open", new_callable=mock_open, read_data=yaml.dump(INVENTORY_WITHOUT_ALL_KEY))
...
@patch("builtins.open", new_callable=mock_open, read_data=yaml.dump(INVENTORY_WITHOUT_HOST_USER))
