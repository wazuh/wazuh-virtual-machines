...
def test_get_component_dependencies_success():
    ...
    components_dependencies = ComponentsDependencies(dependencies_content=dependencies_content, package_type=Package_type.RPM)
...
def test_package_manager_apt():
    dependencies_content = {}
    components_dependencies = ComponentsDependencies(dependencies_content=dependencies_content, package_type=Package_type.DEB)
