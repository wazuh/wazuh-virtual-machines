...
@patch('builtins.open', new_callable=mock_open, read_data='dependency1: version1\ndependency2: version2\n')
def test_dependencies_success(mock_open):    
    ...
    assert dependencies.dependencies_content == {'dependency1': 'version1', 'dependency2': 'version2'}
...
def test_packages_url_content_success(mock_format_component_urls_file):
    mock_format_component_urls_file.return_value = {'package1': 'url1', 'package2': 'url2'}
    ...
    assert packages_url_content.packages_url_content == {'package1': 'url1', 'package2': 'url2'}
...
@patch('provisioner.models.input.format_certificates_urls_file', side_effect=FileNotFoundError)
