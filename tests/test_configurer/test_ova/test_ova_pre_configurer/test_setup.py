...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_success_vboxguest_loaded(
    mock_remove, mock_listdir, mock_isfile, mock_run_command, mock_open_file
):
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_vboxguest_check_failure_missing_ko_file(
    mock_remove, mock_listdir, mock_isfile, mock_run_command
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
        (None, None, None),
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_vboxguest_check_failure_missing_service(
    mock_remove, mock_listdir, mock_isfile, mock_run_command
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_vboxguest_check_passes_with_init_service(
    mock_remove, mock_listdir, mock_isfile, mock_run_command, mock_open_file
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
    ...
    def isfile_side_effect(path):
        if path == "/lib/modules/5.10.0/misc/vboxguest.ko" or path == "/etc/init.d/vboxadd":
            ...
            path == "/usr/lib/systemd/system/vboxadd.service"
            or path == "/etc/rc.d/rc.local"
            or path == "/usr/lib/systemd/system/rc-local.service"
        ):
            return False
        return False
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_vboxguest_check_passes_with_systemd_service(
    mock_remove, mock_listdir, mock_isfile, mock_run_command, mock_open_file
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_rc_local_exists_with_content(
    mock_remove, mock_listdir, mock_isfile, mock_run_command, mock_open_file
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_with_rc_local_service(
    mock_remove, mock_listdir, mock_isfile, mock_run_command, mock_open_file
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
...
@patch("os.listdir")
@patch("os.remove")
def test_install_guest_additions_complete_systemd_scenario(
    mock_remove, mock_listdir, mock_isfile, mock_run_command, mock_open_file
):
    mock_listdir.return_value = ["5.10.0"]
    mock_run_command.side_effect = [
