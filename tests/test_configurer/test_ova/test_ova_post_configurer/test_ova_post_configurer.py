...
def test_steps_system_config(
    ...
    mock_json_load.return_value = {"version": "5.9.9", "stage": "alpha0"}
    ...
    mock_run_command.assert_any_call(f"sudo bash {SCRIPTS_PATH}/messages.sh no 5.9.9-alpha0 wazuh-user")
