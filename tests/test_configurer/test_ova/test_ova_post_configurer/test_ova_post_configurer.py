...
def test_steps_system_config(
    ...
    mock_json_load.return_value = {"version": "0.0.1", "stage": "alpha0"}
    ...
    mock_run_command.assert_any_call(f"sudo bash {SCRIPTS_PATH}/messages.sh no 0.0.1-alpha0 wazuh-user")
