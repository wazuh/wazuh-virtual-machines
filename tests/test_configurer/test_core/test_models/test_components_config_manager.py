...
def example_config_file():
    return {
        ...
        Component.WAZUH_AGENT: [
            {"path": "/path/agent/config", "replace": {"keys": [".key4"], "values": ["value4"]}}
        ],
    }
...
@pytest.mark.parametrize(
    "component_without_mapping", [Component.WAZUH_INDEXER, Component.WAZUH_MANAGER, Component.WAZUH_DASHBOARD, Component.WAZUH_AGENT]
)
