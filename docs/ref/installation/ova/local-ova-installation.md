...
1. Clone the Wazuh Virtual Machines repository and select the Wazuh version you want to install in the OVA, in this case `0.0.1`:

   ```bash
   git clone https://github.com/wazuh/wazuh-virtual-machines && cd wazuh-virtual-machines/ && git checkout v0.0.1
   ```
